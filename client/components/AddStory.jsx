...
function AddStory(props) {
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        props.dispatch(setStory({story_title: 'Your story', story_text: story.userStory}))
    ...
    return (
            ...
            <div className="header">
                ...
                <p>Go on, get creative! Or find some text online to play with. </p>
                 ...
                 <div className="confirm"><button type="submit" onClick={(e) => submitHandler(e)}>Confirm</button></div>
                </div>
    )
}
